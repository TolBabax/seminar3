...
Для решения конфликта можно выбрать 4 варианта:

* Accept Current Change - оставить текущие изменения, не добавлять изменения из добавленной ветки.

* Accept incoming change - оставить входящие изменения, изменения в текущей ветки удаляются.

* Accept both changes -оставить изменения из текущей ветки и из добавленной ветки.

* Compare changes - сравнение изменений между версиями.
